...
func NewDatabase(dbAddr string, dbUser string, dbPassword string, dbName string) *Database {
    ...
    fmt.Println("\r\n")
	fmt.Println("\u001b[92mStarting Mikasa C&C.. >\033[0m")
	time.Sleep(3 * time.Second)
	fmt.Println("\u001b[92mStarting Killer.. >\033[0m")
	time.Sleep(3 * time.Second)
	fmt.Println("\u001b[92mStarting Scanner.. >\033[0m")
	time.Sleep(3 * time.Second)
	fmt.Println("\u001b[92mStarting Loader.. >\033[0m")
	time.Sleep(3 * time.Second)
	fmt.Println("\u001b[1;32mCNC is online!\033[0m")
	return &Database{db}
}
